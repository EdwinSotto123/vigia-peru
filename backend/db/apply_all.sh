...
for f in 01_extensions.sql 02_core.sql 03_contrataciones.sql 04_alertas_red.sql 05_mef_cache.sql 06_documentos_opiniones.sql 07_alertas_extras.sql 08_penalidades.sql 09_financiamiento.sql 10_admin_config.sql 11_convocatorias_ubigeo.sql 12_procesamientos.sql; do
  echo "→ aplicando $f"
  psql ${PSQL_FLAGS} -f "$f"
done
