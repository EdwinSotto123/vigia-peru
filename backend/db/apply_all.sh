...
for f in 01_extensions.sql 02_core.sql 03_contrataciones.sql 04_alertas_red.sql 05_mef_cache.sql 06_documentos_opiniones.sql 07_alertas_extras.sql 08_penalidades.sql 09_financiamiento.sql 10_admin_config.sql 11_convocatorias_ubigeo.sql 12_procesamientos.sql 13_clasificacion.sql 14_lotes.sql 15_retencion_pedidos.sql 16_cobertura.sql 17_documentos_texto.sql 18_verificacion.sql; do
