...
_kw = {}
_planner = build_planner("market_price_agent", config.MODEL, getattr(config, "THINKING", None))
if _planner is not None:
    _kw["planner"] = _planner
_gcc = build_generate_config("market_price_agent", getattr(config, "TEMPERATURE", None),
