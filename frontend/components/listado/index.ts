/** Plantilla Listado (DESIGN_SYSTEM.md §14.1): las piezas que comparten todos los listados. */
export { Indicadores, IndicadoresSkeleton, type Indicador } from "./Indicadores";
