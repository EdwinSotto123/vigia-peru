  ...
  return (
    <div className={cn(hasError && "bg-crimson-soft/40")}>
      <button
        ...
        className="flex w-full items-center gap-2 px-4 py-2 text-left transition-colors duration-rapido hover:bg-paperSoft focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-granate/50 sm:px-5"
      >
        <ChevronRight
          size={14}
          aria-hidden
        ...
        <span className="shrink-0 font-mono text-[11px] tabular-nums text-mute">{events.length}</span>
      </button>
      {abierto && (
