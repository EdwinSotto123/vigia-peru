...
/**
 * Nivel del título del dossier (lo pinta IdentidadDossier). En la página pública es el <h1>; dentro
 ...
 *
 * Va en su propio archivo y no en IdentidadDossier: así el panel lo importa sin arrastrar la cabecera
