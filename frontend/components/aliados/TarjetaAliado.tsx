 ...
 * una fila para grillas densas. El caso "un único destacado" (solo el
 * fundador, hoy) ya no lo maneja esta tarjeta -- lo resuelve Podio.tsx con
 * una posición "vacante" en vez de una tarjeta sola estirada.
 */
