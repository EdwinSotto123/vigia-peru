...
import { Settings, Eye, EyeOff, Download, Trash2, Loader2, Check, Upload, LogIn, ShieldAlert, RefreshCw } from "lucide-react";
  ...
  return (
    <form onSubmit={guardar} className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
      <div className="space-y-6">
        {/* Perfil público */}
        <section className="rounded-2xl border border-line bg-paper p-5 shadow-card sm:p-6" aria-labelledby="perfil-publico">
          <h2 id="perfil-publico" className="text-[10px] font-bold uppercase tracking-widest text-mute">Perfil público de aliado</h2>
          <p className="mt-1 text-sm text-mute">Solo importa si quieres aparecer en el <Link href="/app/aliados" className="underline transition-colors hover:text-heroViolet">muro de aliados</Link> y en los comprobantes de tus aportes. Si no, tus aportes figuran como “Anónimo”.</p>
        ...
        <section className="rounded-2xl border border-line bg-paper p-5 shadow-card sm:p-6" aria-labelledby="notifs">
      ...
      <aside className="space-y-4 lg:sticky lg:top-6 lg:self-start">
        <section className="rounded-2xl border border-line bg-paper p-4 shadow-card">
          <h2 className="text-[10px] font-bold uppercase tracking-widest text-mute">Tu cuenta</h2>
        ...
        <section className="rounded-2xl border border-line bg-paperSoft p-4 shadow-card">
